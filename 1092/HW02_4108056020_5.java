public class HW02_4108056020_5 extends ThreeSum{
	volatile int count;
	final int CORE = 5;
	...
	protected class T_sum extends Thread{
		private final int t, A[], LEN, END;
		public T_sum(final int t, final int A[],
		  final int LEN, final int END){
			this.t=t; this.A=A;
			this.LEN=LEN; this.END=END;
		}
		public void run(){
